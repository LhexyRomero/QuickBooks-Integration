...
<div class="container">
    ...
    <table class='table table-striped'>
            ...
            <tbody>
                <tr>
                    <td class='text-center'><span class="badge badge-primary">READ</span></td>
                    <td>mitsurini392@gmail.com</td>
                    <td>9/18/13 5:23 PM</td>
                    <td>localhost:80/Quickbooks-integration/Customer/customerContacts.php</td>
                    <td>200</td>
                    <td>GET</td>
                    <td><button class='btn btn-primary'>View</button></td>
                </tr>
                <tr>
                    <td class='text-center'><span class="badge badge-primary">CREATE</span></td>
                    <td>mitsurini392@gmail.com</td>
                    <td>9/18/13 5:24 PM</td>
                    <td>localhost:80/Quickbooks-integration/Customer/customerToQB.php</td>
                    <td>200</td>
                    <td>POST</td>
                    <td><button class='btn btn-primary'>View</button></td>
                </tr>
